...
/**
 * Drops what's held for one source and fetches it again, for the field's refresh
 * button, so an editor who has just changed a readme on GitHub can see it here
 * without waiting out the cache or clearing every readme in the site.
 *
...
class RefreshController extends Controller
{
    public function actionIndex(): Response
    {
        ...
        return $this->asJson([
            ...
            // The range is sent along so this can be answered for it: a refresh
            // is exactly the moment a readme turns out to have lost the headings
            // it points at.
